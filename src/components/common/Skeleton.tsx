...
export function Skeleton({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        'relative overflow-hidden rounded-2xl bg-[#1e1e2d]/60 border border-white/5',
...
export function CardSkeleton({ className }: { className?: string }) {
  return (
    <div className={cn('rounded-3xl border border-white/10 bg-[#14141f]/80 p-5 backdrop-blur-xl shadow-soft space-y-4', className)}>
...
export function TransactionRowSkeleton() {
  return (
    <div className="flex items-center gap-3.5 rounded-2xl border border-white/5 bg-[#181826]/70 p-3.5 backdrop-blur-md">
...
export function DashboardSkeleton() {
  return (
    <div className="mx-auto max-w-xl flex flex-col gap-4 pt-3 animate-fade-in">
      ...
      <div className="rounded-[26px] border border-white/10 bg-gradient-to-br from-[#181828] via-[#141420] to-[#0d0d16] p-5 shadow-2xl space-y-5">
        <div className="flex items-center justify-between">
  ...
  return (
    <div className="flex flex-col gap-3.5 p-2 animate-fade-in">
      ...
      <div className="flex justify-start">
        <div className="max-w-[78%] rounded-[20px] rounded-tl-sm p-3.5 bg-[#1e1e2c]/90 border border-white/10 space-y-2">
          <Skeleton className="h-3.5 w-24 rounded-md bg-purple-500/20" />
      ...
      <div className="flex justify-end">
        <div className="max-w-[75%] rounded-[20px] rounded-tr-sm p-3.5 bg-gradient-to-r from-[#9d4edd]/30 to-[#7b2cbf]/30 border border-[#9d4edd]/40 space-y-2">
          <Skeleton className="h-3.5 w-44 rounded-md bg-white/20" />
      ...
      <div className="flex justify-start">
        <div className="max-w-[80%] rounded-[22px] rounded-tl-sm p-3 bg-[#1e1e2c]/90 border border-white/10 space-y-2">
          <Skeleton className="h-3 w-28 rounded-md bg-purple-500/20" />
      ...
      <div className="flex justify-end">
        <div className="max-w-[70%] rounded-[20px] rounded-tr-sm p-2 bg-[#1e1e2c]/90 border border-white/10 space-y-2">
